...
import es.uva.inf.grammar.parser.visitors.RawSymbolTableVisitor;
//import es.uva.inf.grammar.plugin.Issue;
...
import es.uva.inf.grammar.utilities.UtilityFunctions;
...
public class GeneralTestUtilities {
    ...
    public static GrammarParser.FileContext getParseTree(String file_path) throws IOException {


        return getParseTreeFromString(loadFile(file_path));
    }

    public static GrammarParser.FileContext getParseTreeFromString(String fileContent) {
    ...
    public static SymbolTable getRAWSymbolTableFromString(String content){
        ...
        GrammarParser.FileContext root = getParseTreeFromString(content);
    ...
    public static SymbolTable getRAWSymbolTable(String file_path) throws IOException {
        GrammarParser.FileContext tree = getParseTree(file_path);
