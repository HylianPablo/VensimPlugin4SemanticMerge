...
public class ModelParser extends Parser {
	...
	public static final int
		...
		Whitespace=81, Backslash=82, INFO_UNIT=83, OtherCaracter=84, SketchesDelimiter=85;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'<[VIEWS START]>'", "'<[VIEWS END]>'", "'<[GRAPH START]>'", "'<[GRAPH END]>'", 
			"':'", "'('", "'-'", "')'", "'->'", "','", "':IGNORE:'", "':EXCEPT:'", 
	...
	public final ModelContext model() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__44) | (1L << T__46))) != 0) || _la==SketchesDelimiter) {
				{
				setState(170);
	...
	public final ConstraintContext constraint() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__5) | (1L << T__6) | (1L << T__19) | (1L << T__22) | (1L << T__23) | (1L << Star))) != 0) || ((((_la - 73)) & ~0x3f) == 0 && ((1L << (_la - 73)) & ((1L << (Id - 73)) | (1L << (FloatingConstNumber - 73)) | (1L << (DigitSeq - 73)) | (1L << (StringConst - 73)) | (1L << (Keyword - 73)))) != 0)) {
				{
				setState(301);
				expr(0);
				}
	...
	public final ExprAllowSignContext exprAllowSign() throws RecognitionException {
		...
		try {
			...
			case 4:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==T__6 || _la==T__19 || ((((_la - 74)) & ~0x3f) == 0 && ((1L << (_la - 74)) & ((1L << (FloatingConstNumber - 74)) | (1L << (DigitSeq - 74)) | (1L << (StringConst - 74)))) != 0)) {
					{
					{
					setState(366);
					constVensim();
	...
	public final ArrowContext arrow() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 51)) & ~0x3f) == 0 && ((1L << (_la - 51)) & ((1L << (T__50 - 51)) | (1L << (T__51 - 51)) | (1L << (Id - 51)))) != 0)) {
				{
				setState(737);
				typography();
				}
