...
public class BazacoParser extends Parser {
	...
	public static class QuinceContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BazacoVisitor ) return ((BazacoVisitor<? extends T>)visitor).visitQuince(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ObjectVariableContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BazacoVisitor ) return ((BazacoVisitor<? extends T>)visitor).visitObjectVariable(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class GraphDelimiterContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof BazacoVisitor ) return ((BazacoVisitor<? extends T>)visitor).visitGraphDelimiter(this);
			else return visitor.visitChildren(this);
		}
	}
